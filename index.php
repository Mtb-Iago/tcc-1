...
<body>
    ...
    <div class="text-center pt-5">
        <a href="https://github.com/yullobomfim" target="__blank" class="nav-link"><code><i class="fab fa-github-alt"></i>GitHubYullo</code></a>
    </div>
    <div class="row justify-content-center">
        <div>
            <div class="card mb-3 shadow login" id="cardLogin" style="max-width: 540px;">
                <div class="row no-gutters">
                    <div class="col-md-4 align-self-center d-none d-md-block">
                        <img src="./app/storage/pgr.png" class="card-img" alt="Logo do Programa de Gerenciamento de Riscos">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">Gerenciamento de Riscos</h5>
                            <div class="row">
            ...
            <div class="card mb-3 shadow login" id="cardCadastro" style="max-width: 540px; display: none">
                <div class="row no-gutters">
                    <div class="col-md-4 align-self-center d-none d-md-block">
                        <img src="./app/storage/pgr.png" class="card-img" alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">  
                            <h5 class="card-title">Gerenciamento de Riscos</h5>
