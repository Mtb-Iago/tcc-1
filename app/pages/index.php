...
<nav class="navbar sticky-top navbar-dark bg-dark shadow">
    <div class="container">
        <a href="https://github.com/yullobomfim" target="__blank" class="nav-brand d-none d-sm-block"><i class="fab fa-js fa-3x text-warning"></i></a>
        <ul class="nav">
            <li class="nav-item">
                <div class="dropdown">
    ...
    <div class="row justify-content-between">
        ...
        <div class="col-lg-7">
            ...
            <div class="text-center mt-3">
                <a href="https://github.com/yullobomfim" target="__blank" class="nav-link"><code><i class="fas fa-code"></i> GitHubYullo</code></a>
            </div>
        </div>
    </div>
</div>
